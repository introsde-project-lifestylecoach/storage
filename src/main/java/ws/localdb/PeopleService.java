 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://webservice.localdb.lifecoach/", wsdlLocation = "https://introsde-lifecoach-localdb.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://webservice.localdb.lifecoach/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://introsde-lifecoach-localdb.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplementationPort() {
        return super.getPort(new QName("http://webservice.localdb.lifecoach/", "PeopleImplementationPort"), People.class);
    }
    ...
    public People getPeopleImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.localdb.lifecoach/", "PeopleImplementationPort"), People.class, features);
    }
